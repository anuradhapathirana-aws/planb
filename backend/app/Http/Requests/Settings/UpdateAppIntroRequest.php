...
class UpdateAppIntroRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Required only while the intro is on — a hidden intro may keep a
            // blank greeting without blocking the save.
            'intro_greeting_en' => ['nullable', 'required_if_accepted:intro_is_enabled', 'string', 'max:160'],
    ...
    {
        return [
            'intro_greeting_en.required_if_accepted' => 'Enter the greeting message in English.',
